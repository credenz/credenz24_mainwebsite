	...
	<Parallax pages={3} style={{ top: '0', left: '0'  }} className="animation  bg-[#080E3E]">
        ...
        <ParallaxLayer offset={1} speed={0.25}>
          <div className=" flex-col  m-10">
            ...
            <ContactProfileCard className="" name={"Prasanna Pande"}image={imgpp} pos={"Vice Chairperson"}></ContactProfileCard>
<ContactProfileCard  className="" name={"Harsh Khandelwal"}image={imghs} pos={"Joint Secretary"}></ContactProfileCard>
            <ContactProfileCard   className="" name={"Shruti Shinde"}image={imgsh} pos={"Joint Secretary"}></ContactProfileCard>
            </div>
	<div className=" flex cardb justify-around gap-5 m-10">
